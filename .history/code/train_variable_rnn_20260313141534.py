...
train_seqs = pickle.load(open(PATH_TRAIN_SEQS, 'rb'), 4)
train_labels = pickle.load(open(PATH_TRAIN_LABELS, 'rb'), 4)
...
valid_seqs = pickle.load(open(PATH_VALID_SEQS, 'rb'), 4)
valid_labels = pickle.load(open(PATH_VALID_LABELS, 'rb'), 4)
test_seqs = pickle.load(open(PATH_TEST_SEQS, 'rb'), 4)
test_labels = pickle.load(open(PATH_TEST_LABELS, 'rb'), 4)
